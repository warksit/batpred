...
class ColdWeatherPlugin(PredBatPlugin):
    ...
    def on_before_plan(self, context):
        ...
        evening_boost_start = 22 * 60  # Start boosting when evening cheap window opens
        # Only boost during planning period: 22:00 through 07:00.
        # 07:00-22:00: boost served its purpose, don't influence daytime planning.
